...
<div id="wrapper">
    ...
    <div id="page-wrapper">
        ...
        <form method='post' id='userform' action='/admin/save-media-admin'  enctype="multipart/form-data">
            ...
            <?php if($mediaType == 'movie'){?>
                ...
                <label for="sel1" style="margin-top: 20px">Relevant scriptures:</label> <!--<new>-->
                <br> <button type="button" onclick="_open( '/admin/choosebook-multiply', 1000 , 650 );" class="btn btn-info">Click here to add</button>
                <button type="button" id="clearVersesButton" class="btn btn-danger">Clear all selected</button>
                <br>
                 <div style="display: none;" id="selectedVersesTableDiv">
                    <table class="table table-bordered" style="background-color: #F8F8F8;  margin-top: 10px;" id="selectedVersesTable">
                         <thead>
                         <tr>
                ...
                <label class="btn btn-info btn-file">
                    Add media file <input name="file" type="file" style="display: none;">
                </label>
                <br>
            ...
            <?php }elseif($mediaType == 'music'){ ?>
                ...
                <textarea class="form-control" id="usr" name="song_story"></textarea>
