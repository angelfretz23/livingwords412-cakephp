...
class TagsTable extends Table
{
    ...
    {
//        $rules->add($rules->existsIn(['sermon_id'], 'Sermons'));
     ...
     * @param $sermonId
     * 
     * save tags accordion to saves sermon
     */
    public function saveTags($tags, $sermonId){
        
        foreach ($tags as $tag){
            $sTag = $this->newEntity();
            $sTag->sermon_id = $sermonId;
            $sTag->tag_name = $tag;
            $result = $this->save($sTag);
