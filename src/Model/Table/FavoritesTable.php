...
//        $rules->add($rules->existsIn(['user_id'], 'Users'));
    ...
    public function saveFavorites($data)
    {
        $favor = $this->newEntity();
        $favor->media_id = $data['media_id'];
        $favor->media_type = $data['media_type'];
        $favor->user_favorite_id = $data['user_id'];
        $result = $this->save($favor);
